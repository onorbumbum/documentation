...
varied, public, and time-sensitive pricing options than :doc:`pricelists <prices/pricing>`.
...
- :guilabel:`Program Type`: Select the desired :ref:`program type
  <pricing_management/program-types>`.
...
.. note::
   ...
   <pricing_management/program-types>` selected.
...
- :guilabel:`Reward Type`: Select the reward type among :guilabel:`Free Product`,
  ...
  - :guilabel:`Free Product` Reward Type:
  ...
  - :guilabel:`Free Shipping` Reward Type:
